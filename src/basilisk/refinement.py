...
# This file is a copy from incremental.py. It implements the online refinement
# method using the incremental learning procedure. There is a lot of code
# duplication
...
class OnlineRefinementExperiment(Experiment):
